...
from src.pangu.environment.examples.KB.OpenKGSparqlCache import OpenKGSparqlCache
from src.pangu.language.util import split_string_without_square_brackets


def is_entity(input_str):
    if ':Node' in input_str or '/Node' in input_str:
        return True
    return False
...
class OpenKGEnv(Env):
    ...
    def step(self, action: str):
        ...
        filtered_relations = [r for r in relations if r.startswith('https://github.com/OSU-NLP-Group/HippoRAG')]
        return {"Property": filtered_relations, "Classes": classes}
